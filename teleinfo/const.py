...
TELEINFO_KEY = {
	"ADSC": { "metric_length": 12, "content_type": str, "description": "Adresse Secondaire du Compteur", "label": "adresseCompteur"},
	...
	"EAST": { "metric_length": 9, "content_type": int, "description": "Energie active soutirée totale", "label": "energieActiveSoutireeTotale", "class": TeleinfoIndex},
	...
	"ADCO": { "metric_length": 12, "content_type": str, "description": "Adresse du Compteur", "label": "adresseCompteur"},
	"OPTARIF": { "metric_length": 4, "content_type": str, "description": "Option tarifaire choisie", "label": "tarifOption" },
	"BASE": { "metric_length": 9, "content_type": int, "description": "Index option Base", "class": TeleinfoIndex },
	"HCHC": { "metric_length": 9,  "content_type": int, "description": "Index Heures Creuses", "class": TeleinfoIndex },
	"HCHP": { "metric_length": 9, "content_type": int, "description": "Index Heures Pleines", "class": TeleinfoIndex },
	"PTEC": { "metric_length": 4, "content_type": str, "description": "Période Tarifaire en cours", "label": "tarifPeriode" },
	"PAPP": { "metric_length": 5, "content_type": int, "description": "Puissance apparente", "class": TeleinfoApparentPowerMetric },
	"ISOUSC" : { "metric_length": 2, "content_type": int, "description": "Courant souscrit"},
	"IINST": { "metric_length": 3, "content_type": int, "description": "Courant instantané", "class": TeleinfoAmpereMetric },
	"IMAX": { "metric_length": 3, "content_type": int, "description": "Courant max", "class": TeleinfoAmpereMetric },
	"MOTDETAT": { "metric_length": 6, "content_type": str, "description": "Mot d'état"},
	"ADPS": {"content_type": int,
			"description": "Avertissement de Dépassement De Puissance Souscrite",
			"metric_length": 3},
	"BBRHCJB": {"content_type": int,
				"description": "Heures Creuses Jours Bleus",
				"metric_length": 9, "class": TeleinfoIndex},
	"BBRHCJR": {"content_type": int,
				"description": "Heures Creuses Jours Rouges",
				"metric_length": 9, "class": TeleinfoIndex},
	"BBRHCJW": {"content_type": int,
				"description": "Heures Creuses Jours Blancs",
				"metric_length": 9, "class": TeleinfoIndex},
	"BBRHPJB": {"content_type": int,
				"description": "Heures Pleines Jours Bleus",
				"metric_length": 9, "class": TeleinfoIndex},
	"BBRHPJR": {"content_type": int,
				"description": "Heures Pleines Jours Rouges",
				"metric_length": 9, "class": TeleinfoIndex},
	"BBRHPJW": {"content_type": int,
				"description": "Heures Pleines Jours Blancs",
				"metric_length": 9, "class": TeleinfoIndex},
	"DEMAIN": {"content_type": str,
				"description": "Couleur du lendemain",
				"metric_length": 4},
	"EJPHN": {"content_type": int,
			"description": "Heures Normales",
			"metric_length": 9, "class": TeleinfoIndex},
	"EJPHPM": {"content_type": int,
				"description": "Heures de Pointe Mobile",
				"metric_length": 9, "class": TeleinfoIndex},
	"HCHC": {"content_type": int,
			"description": "Heures Creuses",
			"metric_length": 9, "class": TeleinfoIndex},
	"HCHP": {"content_type": int,
			"description": "Heures Pleines",
			"metric_length": 9, "class": TeleinfoIndex},
	"HHPHC": {"content_type": str,
			"description": "Horaire Heures Pleines Heures Creuses",
			"metric_length": 1},
	"IINST1": { "metric_length": 3, "content_type": int, "description": "Courant instantané, phase1", "class": TeleinfoAmpereMetric },
	"IINST2": { "metric_length": 3, "content_type": int, "description": "Courant instantané, phase2", "class": TeleinfoAmpereMetric },
	"IINST3": { "metric_length": 3, "content_type": int, "description": "Courant instantané, phase3", "class": TeleinfoAmpereMetric },
	"IMAX1": { "metric_length": 3, "content_type": int, "description": "Courant max, phase1", "class": TeleinfoAmpereMetric },
	"IMAX2": { "metric_length": 3, "content_type": int, "description": "Courant max, phase2", "class": TeleinfoAmpereMetric },
	"IMAX3": { "metric_length": 3, "content_type": int, "description": "Courant max, phase3", "class": TeleinfoAmpereMetric },
	"PPOT": { "metric_length": 2, "content_type": str, "description": "Présence des potentiels"}
}
...
LINKY_CODE = ["61", "62", "63", "64", "67", "68", "70", "71", "75", "76"]